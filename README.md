...
Se desarrolla un sistema de **Analítica Predictiva** diseñado para identificar proactivamente el riesgo de abandono (*Churn*) en una compañía de telecomunicaciones. 

Utilizando un dataset de **7,043 clientes**, se implementó un flujo de trabajo basado en la metodología científica **CRISP-DM**, logrando un modelo capaz de anticipar fugas con alta sensibilidad técnica y explicabilidad para el negocio.
...
1.  **Tipo de Contrato:** Los contratos mensuales presentan el mayor riesgo.
2.  **Tipo de Internet:** La Fibra Óptica muestra una alta correlación con el Churn.
3.  **Cargos Mensuales:** El incremento en la facturación mensual acelera la deserción.
...
## ⚙️ Instalación y Uso
1.  **Clonar el repositorio:** `git clone https://github.com/[TU_USUARIO]/telecom-churn.git`
2.  **Instalar dependencias necesarias:** `pip install -r requirements.txt`

---

## 🖋️ Autor
**Luz Alizon Mamani Mena** *Monografía final para el Diplomado en Ciencia de Datos y Machine Learning.*
